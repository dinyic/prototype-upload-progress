...
var UploadProgressMethods = {
  uploadProgress: function(element, options) {
    ...
    options = Object.extend({
      ...
      prototypePath: '/javascripts/admin/uploadProgress.js',
      server_timer: "",
      client_timer: ""
    }, options);
...
PrototypeUploadProgressMethods = {
  uploadMovement: function(element, options) {
    if (options.current_percent >= 100) {
      ...
      var container = Prototype.Browser.WebKit ? parent.document.getElementById(options.progressContainer) : $(options.progressContainer);
      container.show();
